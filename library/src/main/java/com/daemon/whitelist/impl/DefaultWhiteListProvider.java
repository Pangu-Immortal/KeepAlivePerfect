...
import com.daemon.whitelist.IWhiteListProvider;
import com.daemon.whitelist.IntentType;
import com.daemon.whitelist.WhiteList;
...
public class DefaultWhiteListProvider implements IWhiteListProvider {
    ...
    public List<WhiteListIntentWrapper> getWhiteList(Application application) {
        ...
        xiaomiGodIntent.putExtra("package_label", WhiteList.getApplicationName(Daemon.getApplication()));
