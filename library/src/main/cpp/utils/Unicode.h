...
int strcmp16(const Char16 *, const Char16 *);
int strncmp16(const Char16 *s1, const Char16 *s2, size_t n);
size_t strlen16(const Char16 *);
size_t strnlen16(const Char16 *, size_t);
Char16 *strcpy16(Char16 *, const Char16 *);
Char16 *strncpy16(Char16 *, const Char16 *, size_t);
Char16 *strstr16(const Char16 *, const Char16 *);
...
// Standard string functions on Char32 strings.
size_t strlen32(const Char32 *);
size_t strnlen32(const Char32 *, size_t);
 ...
 * If returned value is positive, it is able to be converted to Char32, which
